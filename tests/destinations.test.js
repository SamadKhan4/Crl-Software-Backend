...
test('returns only Vidarbha postal areas for name or PIN searches', async () => {
  ...
  await expect(searchDestinations('440001')).resolves.toEqual([{ id: '440001:Nagpur GPO', name: 'Nagpur GPO', district: 'Nagpur', pincode: '440001' }]);

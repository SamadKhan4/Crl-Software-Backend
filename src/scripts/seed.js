    ...
    Customer.findOneAndUpdate(
      { customerCode: "90001" },
      {
        $set: {
          ...
          creditRateCard: [
            { location: "Gondia", transitDays: 1, ratePerKg: 28 },
            { location: "Bhandara", transitDays: 1, ratePerKg: 30 },
            { location: "Pune", transitDays: 4, ratePerKg: 45 },
          ],
          creditCharges: {
            fuelRatePercent: 10,
            handlingCharges: 250,
    ...
    Customer.findOneAndUpdate(
      { customerCode: "90002" },
      {
        $set: {
          ...
          creditRateCard: [
            { location: "Chandrapur", transitDays: 1, ratePerKg: 32 },
            { location: "Nashik", transitDays: 3, ratePerKg: 42 },
            { location: "Aurangabad", transitDays: 3, ratePerKg: 44 },
          ],
          creditCharges: {
            fuelRatePercent: 8,
            handlingCharges: 200,
